...
- następne: approved runtime archive/unarchive operations, richer provider runtime operations, optional embedding providers, packaging/launchd hardening i cross-platform ports.
