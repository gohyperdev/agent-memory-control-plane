...
- następne: richer provider runtime operations, persistent vector indexes and evaluated/consented remote embedding providers, packaging/launchd hardening i cross-platform ports.
