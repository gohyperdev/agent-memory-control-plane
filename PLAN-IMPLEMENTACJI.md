...
Status: aktywny plan implementacji; macOS MVP z multi-host, bezpiecznymi mutacjami, MCP i opcjonalnym RAG lexical/local-hash jest zaimplementowane, a dalsze rozszerzenia są planowane
...
- następne: richer provider runtime operations, evaluated/consented model-backed or remote embedding providers, pełne retention/delete workflows dla warstwy pochodnej oraz cross-platform ports.
